    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            for (PostDTO p : postList) {
                ...
                out.println("</div>");
                out.println("<div class='btn-post'>");
                
                
                // Generar el formulario para enviar el ID del post al servlet "Comentarios"
                out.println("<form action='" + request.getContextPath() + "/Comentarios' method='GET'>");
                out.println("<input type='hidden' name='id' value='" + p.getID() + "'>");
                out.println("<div class='bnt-gen'>");
                out.println("<button class='btn-comentar' type='submit'>");
